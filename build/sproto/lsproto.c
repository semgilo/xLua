...
LUALIB_API void luaL_setfuncs2 (lua_State *L, const luaL_Reg *l, int nup) {
...
#define luaL_newlib(L,l)  (luaL_newlibtable(L,l), luaL_setfuncs2(L,l,0))

#if LUA_VERSION_NUM < 503

#if LUA_VERSION_NUM < 502
lua_Integer lua_tointegerx2(lua_State *L, int idx, int *isnum) {
...
LUALIB_API int luaopen_sproto(lua_State *L) {
	luaL_Reg luax_exts[] = {
